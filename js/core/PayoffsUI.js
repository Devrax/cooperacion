function PayoffsUI(config){
	...
	dom.appendChild(_makeLabel("label_cheat", {x:235, y:90, rotation:45, align:"center", color:"#cccccc"}));
	dom.appendChild(_makeLabel("label_cheat", {x:-10, y:90, rotation:-45, align:"center", color:"#cccccc"}));
